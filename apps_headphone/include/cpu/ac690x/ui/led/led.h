...
#define LEDB_PORT  (LED_POARB|B_LED_IO_BIT)
#define LEDR_PORT  (LED_POARB|R_LED_IO_BIT)

#define LED_INIT_EN()       do{JL_PORTA->PU &= ~B_LED_IO_BIT;JL_PORTA->PD &= ~B_LED_IO_BIT;JL_PORTA->DIR &= ~B_LED_IO_BIT;\
                                     JL_PORTA->PU &= ~R_LED_IO_BIT;JL_PORTA->PD &= ~R_LED_IO_BIT;JL_PORTA->DIR &= ~R_LED_IO_BIT;}while(0)
 
#define LED_INIT_DIS()      do{JL_PORTA->PU &= ~B_LED_IO_BIT;JL_PORTA->PD &= ~B_LED_IO_BIT;JL_PORTB->DIR |= B_LED_IO_BIT;\
                                     JL_PORTA->PU &= ~R_LED_IO_BIT;JL_PORTA->PD &= ~R_LED_IO_BIT;JL_PORTA->DIR |= R_LED_IO_BIT;}while(0)
 
#define B_LED_ON()          do{JL_PORTA->OUT |= B_LED_IO_BIT;}while(0)
#define B_LED_OFF()         do{JL_PORTA->OUT &= ~B_LED_IO_BIT;}while(0)
 
#define R_LED_ON()          do{JL_PORTA->OUT |= R_LED_IO_BIT;}while(0)
#define R_LED_OFF()         do{JL_PORTA->OUT &= ~R_LED_IO_BIT;}while(0)
