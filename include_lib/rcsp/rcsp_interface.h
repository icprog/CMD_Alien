...
#define CBW_CMD_RTC_TIME_OP	            0x92
...
#define CBW_CMD_SPEEX_WAIT_OK			0xA2
#define CBW_CMD_SPEEX_SEND_CANCEL		0xA3
#define CBW_CMD_NOTICE_PLAN_STATUS		0xA4
#define CBW_CMD_NOTICE_CHECK_CONNECT	0xA5
#define CBW_CMD_SPEEX_SEND_CONTINUE		0xA6
#define CBW_CMD_SPEEX_SEND_CONTINUE_END	0xA7
#define CBW_CMD_CONN_DEV_TYPE			0xA8

#define CBW_CMD_AI_TOY_CMD			    0xB0//方案自定义命令
...
#define RCSP_REPORT_SMART_SEND_STATUS  	 (1<<17)

#define CSW_REQUEST_ACK_CBW         (1 << 0)
#define CSW_REQUEST_ACK_DATA        (1 << 1)
...
extern void rcsp_set_music_bs_op_api_do(FILE_OPERATE *fop);
...
extern void rcsp_music_task_init(void);
extern void rcsp_music_task_exit(void);
...
extern tbool rcsp_smart_command_send(u8 cmd, u8 *data, u8 len);



extern void rcsp_fill_packet_head_func(u8 *pkt_p,u16 pkt_flag,u16 data_len,u16 cal_crc_flag);
extern u32 rcsp_fill_packet_frame_func(void* frame_p,char *id_str, u8 code_type,u8 *value,u32 value_len);
extern u32 rcsp_data_send_func(u8 *buf,u16 len,u8 need_csw_replay_flag);
extern u8 rcsp_check_csw_ackflag_func(u8 check_type,u8 send_data_flag);
extern void rcsp_fill_cbw_head_func(void *p_cbw,u8 op,u8 cblen, u32 add_data_len,u8 req_flag);
extern void rcsp_set_ack_csw_sw_func(u8 flag);
extern u8 rcsp_get_data_packet_body_offset();
