...
#if DEC_TYPE_AMR_ENABLE
    #define DEC_PHY_AMR  BIT(DEC_TYPE_AMR)
#else
    #define DEC_PHY_AMR  0
#endif

#if DEC_TYPE_M4A_ENABLE
    #define DEC_PHY_M4A  BIT(DEC_TYPE_M4A)
#else
    #define DEC_PHY_M4A  0
#endif

#if DEC_TYPE_DTS_ENABLE
    #define DEC_PHY_DTS  BIT(DEC_TYPE_DTS)
#else
    #define DEC_PHY_DTS 0
#endif
