...
extern void bt_updata_auth_code_handle_register(void (*handle)());
...
extern u8 *user_get_mac_edr_addr(void);
extern u8* user_get_auth_code(u16 *len);
#endif
