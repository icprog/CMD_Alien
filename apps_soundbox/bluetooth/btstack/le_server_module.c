...
// setup advertisements
	// adv_interval unit:0.625ms  range:0x20-0x4000;
...
void app_set_connect_param(void)
{
	...
	uint16_t conn_interval_min = 0x50;
	uint16_t conn_interval_max = 0x120;
...
//
extern void ble_ancs_setup_init(void);
extern void server_set_advertise_data(const u8 *data); 
extern void sm_set_slave_request_SECurity(int enable);
