...
{
	{0x00,0x00,0x00,0x04,0x00,0x00,0x8},
	{0x00,0x00,0x04,0x0A,0x04,0x00,0x8},
	{0x00,0x00,0x0E,0x0A,0x0E,0x00,0x8},
	{0x00,0x0E,0x0A,0x0A,0x0A,0x0E,0x8},
	{0x00,0x00,0x0E,0x0A,0x0E,0x00,0x8},
	{0x00,0x00,0x04,0x0A,0x04,0x00,0x8},
	{0x00,0x00,0x00,0x04,0x00,0x00,0x8},
...
const u8 pictureEffect25[][LED_COLUMN_NUM+1] =
{
	{0X00,0X04,0X0A,0X0A,0X0A,0X04,50},
...
{
	{0X00,0X06,0X08,0X08,0X08,0X06,EFFECTEXPRESSIONCNT},
};
...
{
	{0X00,0X04,0X04,0X04,0X04,0X04,EFFECTEXPRESSIONCNT},
};
...
{
	{0X00,0X00,0X08,0X0E,0X08,0X00,EFFECTEXPRESSIONCNT},
};
...
{
	{0X00,0X00,0X0A,0X04,0X0A,0X00,PICTURE_FAIL_REFRESH_CNT},
	{0X00,0X00,0X04,0X0E,0X04,0X00,PICTURE_FAIL_REFRESH_CNT},
...
/************power_on***********/
#define PICTURE_POWER_ON_REFRESH_CNT		(31)
const u8 picture_poweron[][LED_COLUMN_NUM+1] =
{
	{0x00,0X02,0X00,0X00,0X00,0X00,PICTURE_POWER_ON_REFRESH_CNT},
	{0x00,0X06,0X02,0X00,0X00,0X00,PICTURE_POWER_ON_REFRESH_CNT},
	{0x00,0X0E,0X06,0X02,0X00,0X00,PICTURE_POWER_ON_REFRESH_CNT},
	{0x00,0X0C,0X0E,0X06,0X02,0X00,PICTURE_POWER_ON_REFRESH_CNT},
	{0x00,0X08,0X0C,0X0E,0X06,0X02,PICTURE_POWER_ON_REFRESH_CNT},	
	{0x00,0X00,0X08,0X0C,0X0E,0X06,PICTURE_POWER_ON_REFRESH_CNT},
	{0x00,0X00,0X00,0X08,0X0C,0X0E,PICTURE_POWER_ON_REFRESH_CNT},
	{0x00,0X00,0X00,0X00,0X08,0X0C,PICTURE_POWER_ON_REFRESH_CNT},
	{0x00,0X00,0X00,0X00,0X00,0X08,PICTURE_POWER_ON_REFRESH_CNT},
...
/************暂停/播放***********/
#define PICTURE_PP_REFRESH_CNT		(30)
const u8 picture_pp[][LED_COLUMN_NUM+1] =
{
	...
	{0X00,0X02,0X00,0X00,0X00,0X00,PICTURE_PP_REFRESH_CNT},
	{0X00,0X02,0X06,0X00,0X00,0X00,PICTURE_PP_REFRESH_CNT},
	{0X00,0X02,0X06,0X0E,0X00,0X00,PICTURE_PP_REFRESH_CNT},
	{0X00,0X02,0X06,0X0E,0X06,0X00,PICTURE_PP_REFRESH_CNT},
	{0X00,0X02,0X06,0X0E,0X06,0X02,PICTURE_PP_REFRESH_CNT},
	{0X00,0X00,0X06,0X0E,0X06,0X02,PICTURE_PP_REFRESH_CNT},
	{0X00,0X00,0X00,0X0E,0X06,0X02,PICTURE_PP_REFRESH_CNT},
	{0X00,0X00,0X00,0X00,0X06,0X02,PICTURE_PP_REFRESH_CNT},
	{0X00,0X00,0X00,0X00,0X00,0X02,PICTURE_PP_REFRESH_CNT},
...
{
	{0X00,0X04,0X0A,0X00,0X04,0X0A,PICTURE_PREV_REFRESH_CNT},
};
...
{
	{0X00,0X0A,0X04,0X00,0X0A,0X04,PICTURE_NEXT_REFRESH_CNT},
};
...
{
	{0x00,0X00,0X00,0X04,0X00,0X00,PICTURE_POWER_ON_REFRESH_CNT},
	{0x00,0X00,0X04,0X04,0X04,0X00,PICTURE_POWER_ON_REFRESH_CNT},
	{0x00,0X0E,0X0A,0X0A,0X0A,0X0E,PICTURE_POWER_ON_REFRESH_CNT},
};
...
{
	{0X00,0X00,0X04,0X00,0X00,0X00,PICTURE_UPDATE_REFRESH_CNT},
	{0X00,0X00,0X04,0X04,0X00,0X00,PICTURE_UPDATE_REFRESH_CNT},
	{0X00,0X00,0X04,0X04,0X04,0X00,PICTURE_UPDATE_REFRESH_CNT},
};
...
/************search***********/
#define PICTURE_SEARCH_REFRESH_CNT		(65)
const u8 picture_search[][LED_COLUMN_NUM+1] =
{
	{0X00,0X02,0X04,0X08,0X04,0X02,PICTURE_SEARCH_REFRESH_CNT},
	{0X00,0X04,0X02,0X04,0X08,0X04,PICTURE_SEARCH_REFRESH_CNT},
	{0X00,0X08,0X04,0X02,0X04,0X08,PICTURE_SEARCH_REFRESH_CNT},
	{0X00,0X04,0X08,0X04,0X02,0X04,PICTURE_SEARCH_REFRESH_CNT},
};
