...
const struct task_info *task_list[] =
{
    ...
    &AI_toy_music_task_info,//music_task_info,//
...
u32 compare_last_task_name(char *last_task_name)
{
    if (last_task_name != NULL)
    {
        if(0 == strcmp(last_task_name,last_task_info->name))
        {
            puts("is last_task\n");
            return 1;
        }
