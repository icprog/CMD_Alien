 ...
 */
/*----------------------------------------------------------------------------*/
int lrc_find(MUSIC_OP_API *m_op_api, void *ext_name)
{
    u32 find_lrc_flag;
    void *lrc_file_hdl;

    find_lrc_flag = lg_dev_get_file_indir(m_op_api->fop_api->cur_lgdev_info, ext_name);//root
    ...
    /* if(FALSE == lrc_analysis(lrc_file_hdl, file_io)) */
    /* { */
        /* printf("analazy err \n"); */
        /* return -1; */
    /* } */
